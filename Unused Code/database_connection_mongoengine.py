...
def test_query(x):
    ...
    query4 = multiQ(__raw__={'communityYear':{'$eq':2018}})
...
if __name__ == "__main__":
    ...
    print(handle_get_request(docType = Person, data={'MINcommunityYear':2016, 'MAXcommunityYear':2017}))